package org.example.controllers.owners;
...
class OwnersControllerTest {
    ...
    void displayOwner() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/owners/1")).andExpect(status().isOk())
                .andExpect(view().name("owners/ownerDetails")).andExpect(model()
    ...
    void processFindFormReturnMany() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/owners")).andExpect(status().isOk())
                .andExpect(view().name("owners/ownersList")).andExpect(model()
                        .attribute("selections", hasSize(2)));
    }
